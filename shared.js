...
const translations = {
  ja: {
    ...
    gameKicker: '清掃ゲーム',
    gameTitle: '海ごみ清掃ゲーム',
    gameDescription: 'ウミガメの診断から始まり、海面を清掃するたびに未体験の海域へランダムに進む5つのミッションです。',
    gameHeroLabel: 'インタラクティブ任務',
    gameHeroValue: '観察 · 清掃 · 探索',
    gameHeroNote: '主な汚染物と一緒に流れ着いたごみを見つけ、海域ごとの影響と回復を体験します。',
  ...
  zh: {
    ...
    gameKicker: '清理游戏',
    gameTitle: '海洋垃圾清理游戏',
    gameDescription: '从海龟问诊开始，每次清空当前海面后，随机进入一个尚未体验的海域，完成 5 次海洋救助。',
    gameHeroLabel: '互动任务',
    gameHeroValue: '观察 · 清理 · 探索',
    gameHeroNote: '找到主要污染物和一同漂来的其他垃圾，在不可预知的路线中观察不同海域的影响与恢复。',
  ...
  en: {
    ...
    gameDescription: 'Begin with the sea turtle, then clear each scene to enter a random unvisited sea and complete five rescue missions.',
    gameHeroLabel: 'Interactive task',
    gameHeroValue: 'Observe · Clean · Explore',
    gameHeroNote: 'Find the main pollutant and the debris drifting beside it, then explore impacts and recovery along an unpredictable route.',
